...
class RefCarbonfootprint(models.Model):
    ...
    originaldatabasename = models.TextField(db_column='OriginalDatabaseName', blank=True, null=True)  # Field name made lowercase.
    approxproportionemissions_usephase = models.FloatField(db_column='ApproxProportionEmissions_usephase', blank=True, null=True)  # Field name made lowercase.
    ef_usephase = models.FloatField(db_column='EF_usephase', blank=True, null=True)  # Field name made lowercase.
    lastreviewdate = models.IntegerField(db_column='LastReviewDate', blank=True, null=True)  # Field name made lowercase.
